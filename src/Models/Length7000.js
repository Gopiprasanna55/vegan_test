  ...
  return (
    <>
    {
      formData.diameter == 200 ?
        <>
          ...
          <Scene obj="models/models/17855 Vågen R Trough section 200 2000 mm.obj" mtl="models/models/17855 Vågen R Trough section 200 2000 mm.mtl" rotation={[0, 0, 0]} position={[-2000, 0, 0]} hexcolor={partname == "Trough Section 2000 Ø200" ? "#08F3E7" : "#838486"} />
          <Scene obj="models/models/17855 Vågen R Trough section 200 2000 mm.obj" mtl="models/models/17855 Vågen R Trough section 200 2000 mm.mtl" rotation={[0, 0, 0]} position={[-4000, 0, 0]} hexcolor={partname == "Trough Section 2000 Ø200" ? "#08F3E7" : "#838486"} />
        ...
        <>
          ...
          <Scene obj="models/models/17855 Vågen R Trough section 300 2000 mm.obj" mtl="models/models/17855 Vågen R Trough section 300 2000 mm.mtl" rotation={[0, Math.PI * 90 / 180, Math.PI * 90 / 180]} position={[-2470, 0, 0]} hexcolor={partname == "Trough Section 2000 Ø300" ? "#08F3E7" : "#838486"} />
          <Scene obj="models/models/17855 Vågen R Trough section 300 2000 mm.obj" mtl="models/models/17855 Vågen R Trough section 300 2000 mm.mtl" rotation={[0, Math.PI * 90 / 180, Math.PI * 90 / 180]} position={[-4470, 0, 0]} hexcolor={partname == "Trough Section 2000 Ø300" ? "#08F3E7" : "#838486"} />
        </>
    }
    ...
    <>
      {
        formData.diameter == 200 ?
          <>
            ...
            <Scene obj="models/models/17855 Intermediate bearing 200.obj" mtl="models/models/17855 Intermediate bearing 200.mtl" rotation={[0, Math.PI * 270 / 180, 0]} position={[-3990, 0, 0]} hexcolor={partname == "Intermedaite Bearing Ø200" ? "#08F3E7" : "#a38d72"} />
          </>
          :
          <>
            ...
            <Scene obj="models/models/17855 Intermediate bearing 300.obj" mtl="models/models/17855 Intermediate bearing 300.mtl" rotation={[0, Math.PI * 270 / 180, 0]} position={[-3490, 0, 0]} hexcolor={partname == "Intermedaite Bearing Ø300" ? "#08F3E7" : "#a38d72"} />
    ...
    <>
      {
        formData.diameter == 200 ?
          <>
            ...
            <Scene obj="models/models/17855 Vågen R Bolt kit 200.obj" mtl="models/models/17855 Vågen R Bolt kit 200.mtl" rotation={[0, Math.PI * 270 / 180, 0]} position={[-6000, -110, 210]} hexcolor={partname == "Vagen R Bolt Kit Ø200" ? "#08F3E7" : "#a38d72"} />
          </>
          :
          <>
            ...
            <Scene obj="models/models/17855 Vågen R Bolt kit 300.obj" mtl="models/models/17855 Vågen R Bolt kit 300.mtl" rotation={[Math.PI * 180 / 180, Math.PI * 90 / 180, 0]} position={[-1500, 0, 0]} hexcolor={partname == "Vagen R Bolt Kit Ø300" ? "#08F3E7" : "#a38d72"} />
...

    {
      formData.diameter == 200 ?
        <>
          {
            formData.outletqty == 1 && <Scene obj="models/models/17855.40.31 200 Outlet.obj" mtl="models/models/17855.40.31 200 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-5950 + formData.outletp1, -200, 0]} hexcolor={partname == "Outlet  Ø200" ? "#08F3E7" : "#838486"} />
          }
          {
            formData.outletqty == 2 &&
            <>
              <Scene obj="models/models/17855.40.31 200 Outlet.obj" mtl="models/models/17855.40.31 200 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-5950 + formData.outletp1, -200, 0]} hexcolor={partname == "Outlet's  Ø200" ? "#08F3E7" : "#838486"} />
              <Scene obj="models/models/17855.40.31 200 Outlet.obj" mtl="models/models/17855.40.31 200 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-6000 + formData.outletp2, -200, 0]} hexcolor={partname == "Outlet's  Ø200" ? "#08F3E7" : "#838486"} />
            </>
          }
        ...
        <>
          {
            formData.outletqty == 1 && <Scene obj="models/models/17855.40.20.004_01 Outlet.obj" mtl="models/models/17855.40.20.004_01 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-5300 + formData.outletp1, -300, 0]} hexcolor={partname == "Outlet  Ø300" ? "#08F3E7" : "#838486"} />
          }
          {
            formData.outletqty == 2 &&
            <>
              <Scene obj="models/models/17855.40.20.004_01 Outlet.obj" mtl="models/models/17855.40.20.004_01 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-5300 + formData.outletp1, -300, 0]} hexcolor={partname == "Outlet's  Ø300" ? "#08F3E7" : "#838486"} />
              <Scene obj="models/models/17855.40.20.004_01 Outlet.obj" mtl="models/models/17855.40.20.004_01 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-5300 + formData.outletp2, -300, 0]} hexcolor={partname == "Outlet's  Ø300" ? "#08F3E7" : "#838486"} />
            </>
          }
