  ...
  return (
    <>
    {
      formData.diameter == 200 ?
        <>
          ...
          <Scene obj="models/17855 Vagen R Trough section 200 3000 mm.obj" mtl="models/17855 Vagen R Trough section 200 3000 mm.mtl" rotation={[0, 0, 0]} position={[-9000, 0, 0]} hexcolor={partname == "Trough Section 3000 Ø200" ? "#08F3E7" : "#838486"} />
        ...
        <>
          ...
          <Scene obj="models/17855 Vagen R Trough section 300 3000 mm.obj" mtl="models/17855 Vagen R Trough section 300 3000 mm.mtl" rotation={[0, Math.PI * 90 / 180, Math.PI * 90 / 180]} position={[-9000, 0, 0]} hexcolor={partname == "Trough Section 3000 Ø300" ? "#08F3E7" : "#838486"} />
    ...
    <>
      {
        formData.diameter == 200 ?
          <>
            ...
            <Scene obj="models/17855 Intermediate bearing 200.obj" mtl="models/17855 Intermediate bearing 200.mtl" rotation={[0, Math.PI * 270 / 180, 0]} position={[-8000, 0, 0]} hexcolor={partname == "Intermediate Bearing Ø200" ? "#08F3E7" : "#a38d72"} />
          ...
          <>
            ...
            <Scene obj="models/17855 Intermediate bearing 300.obj" mtl="models/17855 Intermediate bearing 300.mtl" rotation={[0, Math.PI * 270 / 180, 0]} position={[-7490, 0, 0]} hexcolor={partname == "Intermediate Bearing Ø300" ? "#08F3E7" : "#a38d72"} />
    ...
    <>
      {
        formData.diameter == 200 ?
          <>
            ...
            <Scene obj="models/17855 Vagen R Bolt kit 200.obj" mtl="models/17855 Vagen R Bolt kit 200.mtl" rotation={[0, Math.PI * 270 / 180, 0]} position={[-10000, -110, 210]} hexcolor={partname == "Vagen R Bolt Kit Ø200" ? "#08F3E7" : "#a38d72"} />
          ...
          <>
            ...
            <Scene obj="models/17855 Vagen R Bolt kit 300.obj" mtl="models/17855 Vagen R Bolt kit 300.mtl" rotation={[Math.PI * 180 / 180, Math.PI * 90 / 180, 0]} position={[-5500, 0, 0]} hexcolor={partname == "Vagen R Bolt Kit Ø300" ? "#08F3E7" : "#a38d72"} />
...

    {
      formData.diameter == 200 ?
        <>
          {
             <Scene obj="models/17855.40.31 200 Outlet.obj" mtl="models/17855.40.31 200 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-10940 +outletpos1, -200, 0]} hexcolor={partname == "Outlet  Ø200" ? "#08F3E7" : "#838486"} />
          }
          {
            formData.outletqty == 2 &&
            
              <Scene obj="models/17855.40.31 200 Outlet.obj" mtl="models/17855.40.31 200 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-10940 +outletpos2, -200, 0]} hexcolor={partname == "Outlet  Ø200" ? "#08F3E7" : "#838486"} name="outletqty"/>
        ...
        <>
          {
             <Scene obj="models/17855.40.20.004_01 Outlet.obj" mtl="models/17855.40.20.004_01 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-10332.5 + outletpos1, -300, 0]} hexcolor={partname == "Outlet  Ø300" ? "#08F3E7" : "#838486"} />
          }
          {
            formData.outletqty == 2 &&
            
              <Scene obj="models/17855.40.20.004_01 Outlet.obj" mtl="models/17855.40.20.004_01 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-10332.5 + outletpos2, -300, 0]} hexcolor={partname == "Outlet  Ø300" ? "#08F3E7" : "#838486"} name="outletqty"/>
    ...
    {
      formData.diameter == 200 ? <Scene obj="models/17855 Vagen R End station 200.obj" mtl="models/17855 Vagen R End station 200.mtl" rotation={[Math.PI * 180 / 180, Math.PI * 270 / 180, 0]} position={[-11410, 25, 236]} hexcolor={partname == "Vagen R End station Ø200" ? "#08F3E7" : "#C0C0C0"} /> : <Scene obj="models/17855 Vagen R End station - 300.obj" mtl="models/17855 Vagen R End station - 300.mtl" rotation={[Math.PI * 180 / 180, Math.PI * 270 / 180, Math.PI * 90 / 180]} position={[-10500, 0, 0]} hexcolor={partname == "Vagen R End station Ø300" ? "#08F3E7" : "#C0C0C0"} />
    }
  </>
  )
}
