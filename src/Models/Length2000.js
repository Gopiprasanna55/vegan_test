...
const Length2000 = () => {
  const { formData, partname, inletpos1, inletpos2, outletpos1, outletpos2, material } = useGlobalcontext()

  // let originalString = "Hello world, welcome to the world!";
  // let wordToRemove = "kiran";
  // let modifiedString = partname.replace(new RegExp('\\b' + material + '\\b', 'gi'), '');
  // console.log(modifiedString);
  return (
    <>
      {
        formData.diameter == 200 ? <Scene obj="models/17855 Vagen R Trough section 200 2000 mm.obj" mtl="models/17855 Vagen R Trough section 200 2000 mm.mtl" rotation={[0, 0, 0]} position={[0, 0, 0]}
          hexcolor={(partname === "Trough Section 2000 Ø200 Rotor Carbon Steel" || partname === "Trough Section 2000 Ø200 Rotor Stainless Steel") ? "#08F3E7" : "#838486"} /> : <Scene obj="models/17855 Vagen R Trough section 300 2000 mm.obj" mtl="models/17855 Vagen R Trough section 300 2000 mm.mtl" rotation={[0, Math.PI * 90 / 180, 0]} position={[-1000, 0, 0]}
            hexcolor={(partname == "Trough Section 2000 Ø300 Rotor Carbon Steel") || (partname == "Trough Section 2000 Ø300 Rotor Stainless Steel") ? "#08F3E7" : "#838486"} />
      }
      {
