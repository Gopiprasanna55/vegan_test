    ...
    <>
      ...
      }
      {
        formData.diameter == 200 ?
          <>
            {
              <Scene obj="models/17855.40.31 200 Outlet.obj" mtl="models/17855.40.31 200 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-9940 + outletpos1, -200, 0]} hexcolor={partname == "Outlet  Ø200" ? "#08F3E7" : "#838486"} />
            }
            {
              formData.outletqty == 2 &&

              <Scene obj="models/17855.40.31 200 Outlet.obj" mtl="models/17855.40.31 200 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-9940 + outletpos2, -200, 0]} hexcolor={partname == "Outlet  Ø200" ? "#08F3E7" : "#838486"} name="outletqty" />
          ...
          <>
            {
              <Scene obj="models/17855.40.20.004_01 Outlet.obj" mtl="models/17855.40.20.004_01 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-9332.5 + outletpos1, -300, 0]} hexcolor={partname == "Outlet  Ø300" ? "#08F3E7" : "#838486"} />
            }
            {
              formData.outletqty == 2 &&
      ...
      {
        formData.diameter == 200 ? <Scene obj="models/17855 Vagen R End station 200.obj" mtl="models/17855 Vagen R End station 200.mtl" rotation={[Math.PI * 180 / 180, Math.PI * 270 / 180, 0]} position={[-10410, 25, 236]} hexcolor={partname == "Vagen R End station Ø200" ? "#08F3E7" : "#C0C0C0"} /> : <Scene obj="models/17855 Vagen R End station - 300.obj" mtl="models/17855 Vagen R End station - 300.mtl" rotation={[Math.PI * 180 / 180, Math.PI * 270 / 180, Math.PI * 90 / 180]} position={[-9500, 0, 0]} hexcolor={partname == "Vagen R End station Ø300" ? "#08F3E7" : "#C0C0C0"} />
      }
    </>
  )
}

export default Length11000