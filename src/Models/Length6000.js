  ...
  return (
...

    {
      formData.diameter == 200 ?
        <>
          {
            formData.outletqty == 1 && <Scene obj="models/models/17855.40.31 200 Outlet.obj" mtl="models/models/17855.40.31 200 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-4950 + formData.outletp1, -200, 0]} hexcolor={partname == "Outlet  Ø200" ? "#08F3E7" : "#838486"} />
          }
          {
            formData.outletqty == 2 &&
            <>
              <Scene obj="models/models/17855.40.31 200 Outlet.obj" mtl="models/models/17855.40.31 200 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-4950 + formData.outletp1, -200, 0]} hexcolor={partname == "Outlet's  Ø200" ? "#08F3E7" : "#838486"} />
              <Scene obj="models/models/17855.40.31 200 Outlet.obj" mtl="models/models/17855.40.31 200 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-5000 + formData.outletp2, -200, 0]} hexcolor={partname == "Outlet's  Ø200" ? "#08F3E7" : "#838486"} />
            </>
          }
        ...
        <>
          {
            formData.outletqty == 1 && <Scene obj="models/models/17855.40.20.004_01 Outlet.obj" mtl="models/models/17855.40.20.004_01 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-4300 + formData.outletp1, -300, 0]} hexcolor={partname == "Outlet  Ø300" ? "#08F3E7" : "#838486"} />
          }
          {
            formData.outletqty == 2 &&
            <>
              <Scene obj="models/models/17855.40.20.004_01 Outlet.obj" mtl="models/models/17855.40.20.004_01 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-4300 + formData.outletp1, -300, 0]} hexcolor={partname == "Outlet's  Ø300" ? "#08F3E7" : "#838486"} />
              <Scene obj="models/models/17855.40.20.004_01 Outlet.obj" mtl="models/models/17855.40.20.004_01 Outlet.mtl" rotation={[Math.PI * 270 / 180, 0, Math.PI * 180 / 180]} position={[-4300 + formData.outletp2, -300, 0]} hexcolor={partname == "Outlet's  Ø300" ? "#08F3E7" : "#838486"} />
            </>
          }
    ...
    {
      formData.diameter == 200 ? <Scene obj="models/models/17855 Vågen R End station 200.obj" mtl="models/models/17855 Vågen R End station 200.mtl" rotation={[Math.PI * 180 / 180, Math.PI * 270 / 180, 0]} position={[-5410, 25, 236]} hexcolor={partname == "Vagen R End station Ø200" ? "#08F3E7" : "#C0C0C0"} /> : <Scene obj="models/models/17855 Vågen R End station - 300.obj" mtl="models/models/17855 Vågen R End station - 300.mtl" rotation={[Math.PI * 180 / 180, Math.PI * 270 / 180, Math.PI * 90 / 180]} position={[-4500, 0, 0]} hexcolor={partname == "Vagen R End station Ø300" ? "#08F3E7" : "#C0C0C0"} />
    }
  </>
  )
}

export default Length6000